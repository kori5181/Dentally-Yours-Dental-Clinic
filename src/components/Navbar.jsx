...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Nav Dropdown */}
      <div className={cn(
        "absolute top-[calc(100%+0.5rem)] left-0 w-full bg-white rounded-3xl shadow-2xl border border-primary/10 overflow-hidden flex flex-col transition-all duration-300 md:hidden origin-top backdrop-blur-xl",
